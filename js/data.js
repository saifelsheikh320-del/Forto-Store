...
class StoreDB {
    ...
    getSettings() {
        const defaultSettings = {
            ...
            reviewsEnabled: true,
            reviews: [
                { id: 1, name: "أحمد محمد", comment: "أحذية رائعة جداً وخامة منتزة، التوصيل كان سريع جداً.", rating: 5, date: "2025-12-20" },
                { id: 2, name: "سارة محمود", comment: "المقاس مضبوط تماماً والتغليف فخم جداً، تجربة ممتازة.", rating: 5, date: "2025-12-15" },
                { id: 3, name: "إسلام عادل", comment: "أفضل سنيكرز اشتريتها في الفترة الأخيرة، شكراً فورتو.", rating: 4, date: "2025-12-10" }
            ],
            // Security Settings
